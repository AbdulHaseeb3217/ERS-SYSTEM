...
export default function RiderReset({ navigation, route }) {
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      const res = await fetch(buildUrl("/api/bike_rider/reset"), {
        method: "POST",
      ...
      try {
        ...
        console.log("RESET JSON PARSE ERROR =>", e);
      }

      if (!res.ok || !data?.success) {
        const msg = data?.message || "Could not reset password.";
      ...
      Alert.alert(
        "Success",
        data.message || `Password updated successfully${email ? ` for ${email}` : ""}.`,
        [
          {
            text: "OK",
            onPress: () => navigation.replace("BRiderLogin"),
          },
        ]
      );
    } catch (err) {
        ...
        <View style={styles.content}>
          ...
          <View className="field" style={styles.field}>
            ...
            <View
              style={[
                ...
                focus.p1 && { borderColor: COLORS.inputBorderFocus, shadowOpacity: 0.08 },
                !!error &&
                  (error.includes("fill") || error.includes("least")) && {
          ...
          <View style={styles.field}>
            ...
            <View
              style={[
                styles.inputContainer,
                focus.p2 && { borderColor: COLORS.inputBorderFocus, shadowOpacity: 0.08 },
                !!error &&
